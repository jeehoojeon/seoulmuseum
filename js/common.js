...
function animateCursor() {
  ...
  cursor3.style.left = mouseX + "px";
  cursor3.style.top = mouseY + "px";
...
// .hover-target 요소에 hover 이벤트 바인딩
...
let mainSlide = new Swiper(".main_slide_wrap", {
  ...
  on: {
    ...
    autoplayTimeLeft(swiper, time, progress) {
      ...
      document.querySelector(".swiper-pagination-line-fill").style.height =
        (1 - progress) * 100 + "%";
    },
    init(swiper) {
...
gsap
  ...
  .to(
    cards,
    { y: -300, z: -200, skewY: 5, duration: 1, ease: "power2.in", stagger: 1 },
    "+=0.5"
  ); //앞 애니메이션 끝나고 0.5초 쉬었다가 등장
